...
export default function App($app) {
  ...
  const renderHeader = () => {
    new Header({
      $app, initialState: { sortBy: this.state.sortBy, searchWord: this.state.searchWord, currentPage:this.state.currentPage },
      ...
      handleLoadMore: async () => {
        ...
        this.setState({
          ...
          cities: {
            ...
            isEnd: newCities.isEnd, //데이터가 끝인지 판단하는 여부
          }
        })
      },
      handleItemClick: (id) => {
